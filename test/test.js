...
const configCaracterizacionEspacioConstruido = {
  ...
  layerGroups: [
    {
      optiongroup: 'Número de viviendas',
      layers: [
        {
          id: 1,
          name: 'gridcatv_250',
    ...
    {
      optiongroup: 'Antigüedad de la vivienda',
      layers: [
        {
          id: 4,
          name: 'gridcatv_250',
    ...
    {
      optiongroup: 'Tipologías constructivas',
      layers: [
        {
          id: 5,
          name: 'gridcatv_250',
    ...
    {
      optiongroup: 'Viviendas con piscina',
      layers: [
        {
          id: 8,
          name: 'gridcatv_250',
    ...
    {
      optiongroup: 'Viviendas con espacios abiertos',
      layers: [
        {
          id: 11,
          name: 'gridcatv_250',
    ...
    {
      optiongroup: 'Viviendas con garaje',
      layers: [
        {
          id: 14,
          name: 'gridcatv_250',
